...
public class MessageManager
{
	...
	{		
		...
		//遊戲模式
		message.set("GAMEMODE_SURVIVAL", GAMEMODE_CHANGE);
		message.set("GAMEMODE_SURVIVAL_TOPLAYER", GAMEMODE_TOPLAYER);
		message.set("GAMEMODE_SURVIVAL_HASBEENCHANGE", GAMEMODE_HASBEENCHANGE);
